...
def make_rpn_postprocessor(config, rpn_box_coder, is_train):
    fpn_post_nms_top_n = config.FPN_POST_NMS_TOP_N_TRAIN
    if not is_train:
        fpn_post_nms_top_n = config.FPN_POST_NMS_TOP_N_TEST

    pre_nms_top_n = config.PRE_NMS_TOP_N_TRAIN
    post_nms_top_n = config.POST_NMS_TOP_N_TRAIN
    if not is_train:
        pre_nms_top_n = config.PRE_NMS_TOP_N_TEST
        post_nms_top_n = config.POST_NMS_TOP_N_TEST
    fpn_post_nms_per_batch = config.FPN_POST_NMS_PER_BATCH
